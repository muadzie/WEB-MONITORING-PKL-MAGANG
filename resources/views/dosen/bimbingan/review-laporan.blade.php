...
<div class="row">
        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="card-tools">
                    <a href="{{ route('dosen.laporan.index') }}" class="btn btn-secondary btn-sm">
    ...
    <div class="col-md-4">
        <div class="card card-warning">
            ...
            <form action="{{ route('approval.laporan', $laporan->id) }}" method="POST">
                @csrf
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" name="catatan_revisi" id="catatan_revisi" 
                                  rows="6" placeholder="Masukkan catatan revisi jika perlu"></textarea>
                    </div>
                </div>
