                                    ...
                                    <tbody>
                                        @foreach($kelompok->anggota as $index => $anggota)
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @if($sudahDinilai)
                                                        <a href="{{ route('pt.penilaian.edit', App\Models\Penilaian::where('kelompok_siswa_id', $anggota->id)->where('penilai', 'pt')->first()->id) }}" class="btn btn-warning btn-sm">
                                                            <i class="fas fa-edit"></i> Edit
                                                        </a>
                                                    @else
                                                        <a href="{{ route('pt.penilaian.create', ['kelompok_siswa_id' => $anggota->id]) }}" class="btn btn-primary btn-sm">
