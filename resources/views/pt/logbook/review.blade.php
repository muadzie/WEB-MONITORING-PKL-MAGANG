...
<div class="row">
            ...
            <div class="card-body">
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <td>{{ $logbook->kelompokSiswa->kelompok->dosen->nama_dosen ?? '-' }}</td>
                    </tr>
                    <tr>
                        <th>Tanggal</th>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <br>
                            <a href="{{ route('pt.logbook.download', $logbook->id) }}" class="btn btn-primary btn-sm mt-2">
    ...
    <div class="col-md-4">
        <div class="card card-warning">
            ...
            <form action="{{ route('approval.logbook.pt', $logbook->id) }}" method="POST">
                @csrf
                <div class="card-body">
        ...
        <div class="card mt-3">
            ...
            <div class="card-body">
                <p><i class="fas fa-info-circle text-info"></i> Logbook yang sudah direview tidak dapat diubah.</p>
                <p><i class="fas fa-check-circle text-success"></i> Setujui jika kegiatan sesuai.</p>
                <p><i class="fas fa-times-circle text-danger"></i> Tolak jika kegiatan tidak sesuai.</p>
            </div>
        </div>
    </div>
</div>
